...
export class ApiService {
  ...
  public static getWebNavbarDetailsURL: string = ApiService.HOST_URL + '/user/GetWebNavbarDetails';
  public static getWebFooterDetailsURL: string = ApiService.HOST_URL + '/user/GetWebFooterDetails';
